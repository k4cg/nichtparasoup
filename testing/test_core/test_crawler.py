...
class CrawlerIsImageAddableTestCase(unittest.TestCase):
    ...
    def test_none(self) -> None:
        # arrange
        obj = _C()
        self.crawler.set_is_image_addable(obj.m)
        # act
    ...
    def test_object_bound_method_stay(self) -> None:
        ...
        self.crawler.set_is_image_addable(obj.m)
        # assert
        self.assertEqual(self.crawler.get_is_image_addable(), obj.m)
    ...
    def test_object_bound_method_lambda(self) -> None:
        ...
        self.crawler.set_is_image_addable(obj.m)
        # act
        self.crawler.set_is_image_addable(_C().m)
        # assert
        self.assertIsNone(self.crawler.get_is_image_addable())
    ...
    def test_function(self) -> None:
        ...
        with self.assertRaises(Exception):
            ...
            self.crawler.set_is_image_addable(_f)
...
class CrawlerCrawlCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.images = ImageContainer({Image('1'), Image('2')})
    ...
    def test_crawl_is_addable_true(self) -> None:
        called_is_image_addable_with = ImageContainer()
    ...
    def test_crawl_image_added_called(self) -> None:
        # arrange
        called_image_added_with = ImageContainer()
