...
#wall{margin-top:5ex;display:block;height:100%}#wallbreaker{clear:both;display:none}
...
<a id="toggle" onclick="this.innerHTML = ( iw.toggle() ? 'halt' : 'continue' );">halt</a></div><div id="wall">
