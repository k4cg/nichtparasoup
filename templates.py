...
#header{z-index:99999;display:block;position:fixed;top:0;left:0;right:0;height:5ex;line-height:5ex;text-align:right;padding:0 1em;color:#666;background-color:transparent;cursor:default}
...
<body onload="document.getElementById('interval').onchange(); iw.init('wall');"><div id="header"><div class="content">
update interval: 1
