...
<a id="toggle" onclick="this.innerHTML = ( iw.toggle() ? 'halt' : 'continue' );">halt</a><br/>&#9776;</div>
<div id="wall"><span id="wallbreaker"></span></div><noscript>!!! enable JavaScript !!!</noscript></body></html>
"""
